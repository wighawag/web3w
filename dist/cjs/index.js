    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (chainConfigs) {
            ...
            try {
                ...
                if (error.code === errors_1.CHAIN_CONFIG_NOT_AVAILABLE) {
                    set(chainStore, {
                        chainId,
                        notSupported: true,
                        connecting: false,
            ...
            for (const contractName of Object.keys(contractsInfos)) {
                ...
                if (contractInfo.abi) {
                    ...
                    contractsToAdd[contractName] = ethers_1.proxyContract(new contracts_1.Contract(contractInfo.address, contractInfo.abi, _config.transactions.waitForTransactionDetails
